...
def _quat_scale_to_covar_preci(
    ...
    """PyTorch implementation of `ptxsplat.cuda._wrapper.quat_scale_to_covar_preci()`."""
    batch_dims = quats.shape[:-1]
    assert quats.shape == batch_dims + (4,), quats.shape
    assert scales.shape == batch_dims + (3,), scales.shape
    R = _quat_to_rotmat(quats)  # [..., 3, 3]
...
def _fully_fused_projection(
    ...
    """PyTorch implementation of `ptxsplat.cuda._wrapper.fully_fused_projection()`
...
def _isect_tiles(
    ...
    """Pytorch implementation of `ptxsplat.cuda._wrapper.isect_tiles()`.
...
def _isect_offset_encode(
    ...
    """Pytorch implementation of `ptxsplat.cuda._wrapper.isect_offset_encode()`.
...
def accumulate(
    ...
    `ptxsplat.rasterize_to_indices_in_range`.
...
def _rasterize_to_pixels(
    ...
    """Pytorch implementation of `ptxsplat.cuda._wrapper.rasterize_to_pixels()`.
...
def _spherical_harmonics(
    ...
    """Pytorch implementation of `ptxsplat.cuda._wrapper.spherical_harmonics()`."""
