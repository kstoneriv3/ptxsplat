...
from ptxsplat.cuda._torch_impl import _quat_scale_to_matrix
...
def _fully_fused_projection_2dgs(
    ...
    """PyTorch implementation of `ptxsplat.cuda._wrapper.fully_fused_projection_2dgs()`
...
def _rasterize_to_pixels_2dgs(
    ...
    """Pytorch implementation of `ptxsplat.cuda._wrapper.rasterize_to_pixels_2dgs()`.
