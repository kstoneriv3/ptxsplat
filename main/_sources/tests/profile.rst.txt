...
`ptxsplat` is developed with efficiency in mind, while also supports trade-offs between
...
the impact of the above arguments in `ptxsplat`. "Mem" denotes for
...
.. code-block:: bash
    ...
    python profiling/main.py --backend ptxsplat ptxsplat-legacy inria \
        --batch_size 1 --scene_grid 5 --channels 3

===========================  ========  =============  ==========  ==========  ==========
Backend                      Packed    Sparse Grad      Mem (GB)  FPS[fwd]    FPS[bwd]
===========================  ========  =============  ==========  ==========  ==========
ptxsplat v1.0.0                True      True             **0.35**  132.0       84.8
ptxsplat v1.0.0                True      False            **0.35**  160.8       88.4
ptxsplat v1.0.0                False     False                0.48  **171.8**   **97.1**
ptxsplat v0.1.11               n/a       n/a                  0.62  129.9       91.1
...
Backend                      Packed    Sparse Grad      Mem (GB)  FPS[fwd]      FPS[bwd]
===========================  ========  =============  ==========  ============  ============
ptxsplat v1.0.0                True      True             **1.41**  42.9 x 4      24.1 x 4
ptxsplat v1.0.0                True      False            **1.41**  43.9 x 4      24.0 x 4
ptxsplat v1.0.0                False     False                2.05  **46.1 x 4**  **25.5 x 4**
ptxsplat v0.1.11               n/a       n/a                  1.83  32.5 x 4      21.6 x 4
...
Backend                      Packed    Sparse Grad      Mem (GB)  FPS[fwd]    FPS[bwd]
===========================  ========  =============  ==========  ==========  ==========
ptxsplat v1.0.0                True      True             **0.61**  124.5       43.6
ptxsplat v1.0.0                True      False            **0.61**  157.0       **44.3**
ptxsplat v1.0.0                False     False            **0.61**  **168.4**   44.2
ptxsplat v0.1.11               n/a       n/a                  0.83  18.3        6.9
...
Backend                      Packed    Sparse Grad      Mem (GB)  FPS[fwd]      FPS[bwd]
===========================  ========  =============  ==========  ============  ============
ptxsplat v1.0.0                True      True             **2.45**  36.8 x 4      **10.9 x 4**
ptxsplat v1.0.0                True      False            **2.45**  40.4 x 4      **10.9 x 4**
ptxsplat v1.0.0                False     False                2.48  **42.1 x 4**  **10.9 x 4**
ptxsplat v0.1.11               n/a       n/a                  3.28  4.5 x 4       1.7 x 4
...
Backend                      Packed    Sparse Grad      Mem (GB)  FPS[fwd]    FPS[bwd]
===========================  ========  =============  ==========  ==========  ==========
ptxsplat v1.0.0                True      True             **1.44**  53.7        **39.2**
ptxsplat v1.0.0                True      False                3.08  **62.1**    34.6
ptxsplat v1.0.0                False     False                5.67  59.2        37.5
ptxsplat v0.1.11               n/a       n/a                  9.86  23.8        21.1
...
Backend                      Packed    Sparse Grad      Mem (GB)  FPS[fwd]    FPS[bwd]
===========================  ========  =============  ==========  ==========  ==========
ptxsplat v1.0.0                True      True             **2.31**  45.1        **38.4**
ptxsplat v1.0.0                True      False                6.11  **47.3**    28.9
ptxsplat v1.0.0                False     False               12.17  39.3        25.8
ptxsplat v0.1.11               n/a       n/a                  OOM   OOM         OOM
