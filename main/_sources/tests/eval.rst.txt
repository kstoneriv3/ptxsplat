...
.. table:: Performance on `Mip-NeRF 360 Captures <https://jonbarron.info/mipnerf360/>`_ (Averaged Over 7 Scenes)
    ...
    +---------------------+-------+-------+-------+------------------+------------+
    | ptxsplat-7k           | 27.21 | 0.831 | 0.202 | **4.3GB**        | **5m35s**  |
    +---------------------+-------+-------+-------+------------------+------------+
    | inria-30k           | 28.95 | 0.870 | 0.138 | 9.0 GB           | 37m13s     |
    +---------------------+-------+-------+-------+------------------+------------+
    | ptxsplat-30k (1 GPU)  | 28.95 | 0.870 | 0.135 | **5.7 GB**       | **35m49s** |
    +---------------------+-------+-------+-------+------------------+------------+
    | ptxsplat-30k (4 GPUs) | 28.91 | 0.871 | 0.135 | **2.0 GB**       | **11m28s** |
    +---------------------+-------+-------+-------+------------------+------------+
...
Powered by `ptxsplat`'s efficient CUDA implementation, the training takes up to
**4x less GPU memory** with up to **15% less time** to finish than the official implementation.

Feature Ablation
----------------------------------------------
Evaluation of features provided in `ptxsplat` on Mip-NeRF (averaged over 7 scenes). We ablate `ptxsplat` with default settings, with absgrad and mcmc densification strategies, and antialiased mode.
...
+=============================+=======+=======+=======+==========+=========+============+
| ptxsplat (default settings)   | 29.00 | 0.87  | 0.14  | 3237318  | 5.62    | 19.39      |
+-----------------------------+-------+-------+-------+----------+---------+------------+
...
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| ptxsplat-7k       | **6.10**|**2.20**|**1.93** |**7.57**|**2.89** |**2.04**|**6.25**|
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| inria-30k       |   11.56 |   7.70 |    6.73 |  11.04 |    8.33 |  8.50  |  8.82  |
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| ptxsplat-30k      |**10.58**|**2.29**| **2.23**|**9.88**| **3.17**|**2.79**|**8.10**|
+-----------------+---------+--------+---------+--------+---------+--------+--------+
...
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| ptxsplat-7k       |  **319**| **299**|  **318**| **415**|  **389**|**301** |**304** |
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| inria-30k       |   2980  |   1552 |    1725 |   3092 |    2144 |  1773  |  2366  |
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| ptxsplat-30k      | **2964**|**1422**| **1621**|**3013**|**2020** |**1708**|**2299**|
+-----------------+---------+--------+---------+--------+---------+--------+--------+
...
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-7k  |   23.71 |  29.66 |   27.14 |  26.30 |   28.86 | 29.21 | 25.62 |
+------------+---------+--------+---------+--------+---------+-------+-------+
| inria-30k  |   25.19 |  32.21 |   29.02 |  27.29 |   31.07 | 31.31 | 26.56 |
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k |   25.22 |  32.06 |   29.02 |  27.32 |   31.16 | 31.36 | 26.53 |
+------------+---------+--------+---------+--------+---------+-------+-------+
...
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-7k  | 0.668   | 0.922  | 0.878   | 0.833  | 0.902   | 0.893 | 0.720 |
+------------+---------+--------+---------+--------+---------+-------+-------+
| inria-30k  | 0.763   | 0.941  | 0.906   | 0.863  | 0.925   | 0.918 | 0.771 |
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k | 0.764   | 0.941  | 0.907   | 0.865  | 0.926   | 0.918 | 0.768 |
+------------+---------+--------+---------+--------+---------+-------+-------+
...
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-7k  | 0.324   | 0.162  | 0.206   | 0.123  | 0.127   | 0.217 | 0.253 |
+------------+---------+--------+---------+--------+---------+-------+-------+
| inria-30k  | 0.177   | 0.133  | 0.157   | 0.078  | 0.096   | 0.168 | 0.155 |
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k | 0.172   | 0.132  | 0.154   | 0.075  | 0.094   | 0.164 | 0.153 |
+------------+---------+--------+---------+--------+---------+-------+-------+
...
+-----------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-7k       |   3.62M |  1.17M |   1.02M |  4.48M |   1.63M | 1.11M | 3.71M |
+-----------------+---------+--------+---------+--------+---------+-------+-------+
| inria-30k       |   6.06M |  1.24M |   1.19M |  5.71M |   1.78M | 1.55M | 4.82M |
+-----------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k      |   6.26M |  1.25M |   1.21M |  5.84M |   1.79M | 1.59M | 4.81M |
+-----------------+---------+--------+---------+--------+---------+-------+-------+
...
The evaluation of `ptxsplat-X` can be reproduced with the command
:code:`cd examples; bash benchmarks/basic.sh`
within the ptxsplat repo (commit 6acdce4).
...
+---------------------+-------+-------+-------+------------------+------------+
| ptxsplat-30k          | 28.76 | 0.867 | 0.145 | **3.70 GB**      | **15m44s** |
+---------------------+-------+-------+-------+------------------+------------+
...
+---------------------+-------+-------+-------+------------------+------------+
| ptxsplat-30k          | 27.80 | 0.842 | 0.169 | **3.61 GB**      | **16m44s** |
+---------------------+-------+-------+-------+------------------+------------+
...
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| ptxsplat-30k      |   6.89  |**2.19**| **1.93**|**4.48**| **2.14**|**2.30**|  6.00  |
+-----------------+---------+--------+---------+--------+---------+--------+--------+
...
+-----------------+---------+--------+---------+--------+---------+--------+--------+
| ptxsplat-30k      |**1231** |**788** |  **803**| **985**|  **828**| **789**|**1057**|
+-----------------+---------+--------+---------+--------+---------+--------+--------+
...
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k |   24.97 |  31.94 |   28.76 |  26.95 |   31.08 | 31.27 | 26.37 |
+------------+---------+--------+---------+--------+---------+-------+-------+
...
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k | 0.764   | 0.937  | 0.899   | 0.849  | 0.921   | 0.915 | 0.761 |
+------------+---------+--------+---------+--------+---------+-------+-------+
...
+------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k | 0.189   | 0.134  | 0.162   | 0.091  | 0.101   | 0.169 | 0.166 |
+------------+---------+--------+---------+--------+---------+-------+-------+
...
+-----------------+---------+--------+---------+--------+---------+-------+-------+
| ptxsplat-30k      |   3.88M |  0.92M |   0.73M |  2.49M |   0.87M | 1.03M | 3.40M |
+-----------------+---------+--------+---------+--------+---------+-------+-------+
...
within the ptxsplat repo (commit 48abf70).
