...
def test_ns_compare_viewer_launcher_contract() -> None:
    ...
    assert 'UPSTREAM_CONFIG="/workspace/results/ns-compare/upstream/${SELECTED_SCENE}/splatfacto/matched-1000/config.yml"' in text
    assert 'PTXSPLAT_CONFIG="/workspace/results/ns-compare/ptxsplat/${SELECTED_SCENE}/splatfacto/matched-1000/config.yml"' in text
